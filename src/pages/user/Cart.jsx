...
export default function Cart() {
    ...
    return (
        <div className="w-full min-h-screen bg-[#f8f9fa] py-6 px-6 sm:px-8 lg:px-12" style={{ fontFamily: "'Inter', 'Segoe UI', sans-serif" }}>

            {/* Back Button */}
            <Link
                to="/user"
                className="flex items-center gap-2 text-gray-500 hover:text-[#2d5a3d] mb-6 transition-colors font-medium group !no-underline w-fit"
            >
            ...
            <div className="mb-6">
                ...
                <p className="text-gray-500 text-sm mt-1">{cartItems.length} {cartItems.length === 1 ? 'item' : 'items'} in your cart</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-4">
                    {cartItems.map((item) => (
                        <div key={item.id} className="bg-white rounded-2xl p-4 border border-gray-100 hover:shadow-sm transition-shadow">
                            <div className="flex gap-4">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <span className="text-lg font-bold text-[#2d5a3d]">₹{item.price}</span>
                ...
                <div className="lg:col-span-1">
                    <div className="bg-white rounded-2xl p-6 border border-gray-100 sticky top-24">
                        ...
                        <button className="w-full bg-[#2d5a3d] text-white h-11 rounded-lg font-semibold text-sm hover:bg-[#234830] transition-all shadow-md shadow-green-900/10 active:scale-[0.99] mb-3">
                            Proceed to Checkout
                        </button>
